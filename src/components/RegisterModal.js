...
import './CompaQr.css'; // Asegúrate de tener un archivo CSS para estilos
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 400 && text.includes('email ya registrado')) {
          setPopupMessage('Email ya registrado');
          setShowPopup(true);
